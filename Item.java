...
public class Item {
  ...
  private int quantity;
   /**
   * Constructor
   * @param name1 = name of an item
   * @param quant = quantity of a specific item
   */
   ...
   * compare to method
   * Compares the items
   * @param a = object of type Item to be compared
 ...
 /**
   ...
   * @param a = number that will be set to the quantity of the item
   */
   ...
   * @param a = the quantity number to be updated
   */
   ...
   * @param a = the quantity to be refilled
   */
   ...
   * @param amount = check the amount of an item we have
